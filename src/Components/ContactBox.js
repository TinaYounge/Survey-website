...
function ContactBox() {
  return <div> 
      <Typography  
         ...
         mt={3}
         mb={1}
          style={{ fontWeight: "bold" , color:"#00224b" }} ><AccountCircleIcon/><span style=
          {{marginLeft:"5px", paddingBottom:900}}> YOUR NAME: </span> </Typography>
      <TextField 
...
<Typography  
        mb={1}
         style={{ fontWeight: "bold" , color:"#00224b" }} ><EmailIcon/> <span style=
        {{marginLeft:"5px", paddingBottom:900}}> EMAIL:</span> </Typography>
<TextField 
      sx={{width:"100%", border:"1px solid #e0e3e5",marginBottom:5}}
  id="outlined"
